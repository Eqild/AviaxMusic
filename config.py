...
class Config:
    def __init__(self):
        ...
        self.DURATION_LIMIT = int(getenv("DURATION_LIMIT", 6000000)) * 60
        self.QUEUE_LIMIT = int(getenv("QUEUE_LIMIT", 6000000))
        self.PLAYLIST_LIMIT = int(getenv("PLAYLIST_LIMIT", 6000000))
        ...
        # read API_KEY from an env var named API_KEY
        ...
        # read COOKIES_URL from env var named COOKIES_URL (space-separated batbin links)
        self.COOKIES_URL = [
